...
| Cost | What happens |
|---|---|
| **Distribution model** | `docker run ghcr.io/xray-eval/xray` no longer works alone. README grows a "first set up a Postgres" section. The install funnel collapses. |
