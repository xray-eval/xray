 ...
 * transcription calls) with the internal per-request timeout. When either
 * fires, the merged signal aborts — so a failing sibling cancels the
 * in-flight siblings instead of letting them keep burning the API quota.
 */
